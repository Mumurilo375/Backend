...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('platforms', [
      { name: 'Steam', slug: 'steam', icon_url: null, is_active: true, created_at: now },
      { name: 'PlayStation', slug: 'playstation', icon_url: null, is_active: true, created_at: now },
      { name: 'Xbox', slug: 'xbox', icon_url: null, is_active: true, created_at: now },
      { name: 'Nintendo Switch', slug: 'nintendo-switch', icon_url: null, is_active: true, created_at: now },
    ], {});
